const CACHE_NAME = 'safar-v2026-05-04';
const ASSETS = [
    './',
    './index.html',
    './css/style.css', // O'zingizning CSS faylingiz yo'li
    './js/main.js',    // O'zingizning JS faylingiz yo'li
    // Boshqa barcha aktivlarni (rasm, shrift) shu yerga qo'shing
];
...
// Faollashtirish (Activate) - Eski keshlarni tozalash
...
// Tarmoq so'rovlarini ushlash (Fetch)
